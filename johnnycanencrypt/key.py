...
from .johnnycanencrypt import SameKeyError, add_uid_in_cert, certify_key, decrypt_bytes_on_card, decrypt_file_on_card, decrypt_filehandler_on_card, get_card_details, get_card_version, revoke_uid_in_cert, sign_bytes_detached_on_card, sign_file_detached_on_card, sign_file_on_card, update_password, update_primary_expiry_in_cert, update_subkeys_expiry_in_cert  # noqa: F401
...
from johnnycanencrypt.utils import (DB_UPGRADE_DATE, convert_fingerprint, createdb,
                    to_sort_by_expiry)
...
class KeyStore:
    ...
    def update_expiry_in_subkeys(
        ...
        newcert = update_subkeys_expiry_in_cert(
