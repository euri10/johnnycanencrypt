...
UPDATE_PASSWORD_SQL = "update keys set keyvalue=:keyvalue where fingerprint=:fingerprint"
...
UPDATE_SUBKEY_EXPIRATION_SQL = "UPDATE subkeys set expiration=:expiration where fingerprint=:fingerprint"

UPDATE_KEY_EXPIRATION_SQL = "UPDATE keys set expiration=:expiration where fingerprint=:fingerprint"

UPDATE_REVOKED_SQL = "UPDATE uidvalues set revoked=:revoked where id=:key_id returning *"
