...
def exp_parse_keyring_file(certfile: str) -> list[tuple[dict[str, str], bytes]]: ...
...
def get_signing_pubkey(certdata: bytes) -> dict[str, str]: ...
...
def encrypt_file_internal(
    publickeys: list[bytes], filepath: bytes, output: bytes, armor: bool | None
) -> bytes: ...
